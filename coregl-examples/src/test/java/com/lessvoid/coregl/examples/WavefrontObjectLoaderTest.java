...
/*
  ...
  public void testVertexLine() throws Exception {
    final WavefrontObjectLoader loader = new WavefrontObjectLoader(stream("v 1.51263 2.4e-05 0.28125"));
  ...
  public void testVertexTextureCoords() throws Exception {
    final WavefrontObjectLoader loader = new WavefrontObjectLoader(stream("vt 0.0307216 0.755072"));
  ...
  public void testVertexNormal() throws Exception {
    final WavefrontObjectLoader loader = new WavefrontObjectLoader(stream("vn -1 0 0"));
  ...
  public void testSimpleFace() throws Exception {
    final WavefrontObjectLoader loader = new WavefrontObjectLoader(stream("f 21 22 23"));
  ...
  public void testSimpleFaceWithTextureCooreds() throws Exception {
    final WavefrontObjectLoader loader = new WavefrontObjectLoader(stream("f 21/1 22/2 23/3"));
    assertSize(loader, 0, 0, 0, 1, 1, 1, 1);
    assertInts(loader.getFacesVertexIndizes().get(0), 21, 22, 23);
  ...
  public void testFace() throws Exception {
    final WavefrontObjectLoader loader = new WavefrontObjectLoader(stream("f 21/1/1 22/2/1 23/3/1"));
    assertSize(loader, 0, 0, 0, 1, 1, 1, 1);
    assertInts(loader.getFacesVertexIndizes().get(0), 21, 22, 23);
    assertInts(loader.getFacesTextureIndizes().get(0), 1, 2, 3);
  ...
  private void assertSize(final WavefrontObjectLoader loader,
