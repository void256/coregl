...
public class CoreVersion {
   ...
   * <code>glGetString(GL_VERSION)</string> into this method, as it will look
   ...
   * <code>gl.getUtil().getGLVersion().checkAgainst(verCheck);</code>
   * 
   * @param gl
   ...
   * string:<br/>
   * 1) <code>glGetString(GL_SHADING_LANGUAGE_VERSION)</code> should return a
   ...
   * major/minor version IDs parsed.<br/>
  ...
  /**
   * Convenience method - equivalent to:
   * <code>gl.getUtil().getGLSLVersion().checkAgainst(verCheck);</code>
   * 
   * @param gl
